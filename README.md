<h1 align="center">SC-Tool - Powerful DDoS Script With 9 Methods</h1>
...
* ```git clone https://github.com/skintclover/SC-tool.git```
* ```cd SC-Tool; sh install.sh```

* Install CentOS

* ```cd SC-Tool; sh installCentOS.sh```
